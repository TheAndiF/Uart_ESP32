...
static const char* FW_BUILD_VERSION = "v0.28";
...
static String uartFileUploadPage() {
  ...
  h += "<fieldset><legend>Status und Diagnose</legend><p><b>Status:</b> <span id='up_status'>bereit</span></p><p><b>Phase:</b> <span id='up_phase'>idle</span> &nbsp; <b>UART RX-Stille:</b> <span id='up_rxage'>0</span> ms</p><p><b>Ziel:</b> <span class='mono' id='up_target_status'>-</span></p><p><b>Datei:</b> <span id='up_name'>-</span></p><p><b>Fortschritt:</b> <span id='up_bytes'>0 / 0</span> Byte &nbsp; <b>Block:</b> <span id='up_block'>-</span></p><p><b>UART-Teilsegment:</b> <span id='up_segment'>-</span> &nbsp; <b>Segmentgroesse:</b> <span id='up_seglen'>-</span> Byte</p><p><b>CRC lokal:</b> <span id='up_lcrc'>-</span> &nbsp; <b>CRC BX3:</b> <span id='up_rcrc'>-</span></p><p><b>Fehler:</b> <span id='up_errors'>0</span> &nbsp; <b>Block-Retries:</b> <span id='up_retries'>0</span> &nbsp; <b>Geschwindigkeit:</b> <span id='up_rate'>0</span> KiB/s</p><progress id='up_progress' value='0' max='100' style='width:100%;height:24px'></progress><p id='up_note' class='small'>Datei auswaehlen und Upload starten.</p></fieldset>";
  h += uartNav(); h += "<a class='btn' href='/'>Zurueck</a>";
  h += R"rawliteral(<script>
const UP_BLOCK=4096;
