...
static const char* FW_BUILD_VERSION = "v0.19";
...
static String uartImageTransferPage() {
  ...
  h += "<p class='small'>Verifiziertes, blockweises Backup eines BX3-MTD-Devices ueber die serielle Shell. v0.19 nutzt CRC32 (POSIX cksum) pro Block, einen groesseren UART-RX-Puffer, aggressiveres RX-Draining und einen einmalig installierten BX3-Blockhelfer. Die Gesamt-SHA256-Pruefung bleibt erhalten.</p>";
